...
def health():
    ...
    calculate_life_expectancy(user.age, user.gender)
    time.sleep(1)
...
def calculate_life_expectancy(age, gender):
    ...
    """
    weeks_in_a_year = 52
    user_age_weeks = age * weeks_in_a_year
...
def human_to_dog_years(age):
    ...
    rest_dog_years = 5
    if age == 1:
        dog_years = year_one_dog
    elif age == 2:
        dog_years = year_one_dog + year_two_dog
    else:
        dog_years = (year_one_dog + year_two_dog) + (rest_dog_years * age)
    print(
